...
class TrainEigenFaces:
    ...
    def process_image(self, inImg):
        ...
        if self.count_captures < NUM_TRAINING:
            ...
            faces = self.face_cascade.detectMultiScale( gray_resized, scaleFactor=1.1, minNeighbors=5, minSize=(30, 30),
